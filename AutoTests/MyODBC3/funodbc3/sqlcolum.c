				...
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr)
{
	...
	SWORD                   sErr=0;
/* ------------------------------------------------------------------------- */
	UCHAR                   create[MAX_NAME_LEN+MAX_NAME_LEN+MAX_NAME_LEN+MAX_NAME_LEN+1];
...
/* ------------------------------------------------------------------------- */
	...
	lstrcat(create," TYP_FIXED DECIMAL(15,2), TYP_FLOAT FLOAT(15) , ");
...
/* ------------------------------------------------------------------------- */
	...
	DIAGRECCHECK(SQL_HANDLE_STMT, *phstmt, 1, lpSrvr,SQL_SUCCESS, rc,"SQLColumns");
	...
	while(TRUE) {
      ...
      DIAGRECCHECK(SQL_HANDLE_STMT, *phstmt, 1, lpSrvr,SQL_SUCCESS, rc,"SQLFetch");
		...
		if (rc == SQL_ERROR || rc == SQL_SUCCESS_WITH_INFO) {
			/* Show Error */
         DIAGRECCHECK(SQL_HANDLE_STMT, *phstmt, 1, lpSrvr,SQL_SUCCESS, rc,"SQLError");
		}
