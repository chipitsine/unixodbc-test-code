...
/* ------------------------------------------------------------------------- */
	...
	lstrcat(create," (ID INTEGER, NAME CHAR(80), VNAME CHAR(80), STR CHAR(120), ORT CHAR(60), AGE SMALLINT, GEHALT DECIMAL(8,2))");
...
/* ------------------------------------------------------------------------- */
	...
	DIAGRECCHECK(SQL_HANDLE_STMT, *phstmt, 1, lpSrvr,SQL_SUCCESS, rc,"SQLStatistics");
	...
	while(TRUE) {
		...
		rc = SQLFetch(*phstmt);
      DIAGRECCHECK(SQL_HANDLE_DBC, *phdbc, 1, lpSrvr,SQL_SUCCESS, rc,"SQLFetch");

		if (rc == SQL_ERROR || rc == SQL_SUCCESS_WITH_INFO) {
			/* Show Error */
         DIAGRECCHECK(SQL_HANDLE_DBC, *phdbc, 1, lpSrvr,SQL_SUCCESS, rc,"SQLError");
		}
