...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von CHAR Datentyp 1MB šbertragung.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "NETCHARTEST"
#define TABLE "TABCHAR"
...
/* ---------------------------------------------------------------------har- */
	...
	lstrcpy(colname," ( VARC1 CHAR(254), VARC2 CHAR(254),");
	lstrcat(colname," VARC3 CHAR(254), VARC4 CHAR(254) )");
	...
	rc = SQLBindParameter(*phstmt, 1, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_CHAR, MAX_VALUE+1, 0, value, MAX_DATA+1, &cbvalue);
	...
	rc = SQLBindParameter(*phstmt, 2, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_CHAR, MAX_DATA+1, 0, value, MAX_DATA+1, &cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindParameter");
	rc = SQLBindParameter(*phstmt, 3, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_CHAR, MAX_DATA+1, 0, value, MAX_DATA+1, &cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindParameter");
	rc = SQLBindParameter(*phstmt, 4, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_CHAR, MAX_DATA+1, 0, value, MAX_DATA+1, &cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindParameter");
	...
	z = lstrlen(value);
	szLogPrintf(lpSrvr, FALSE, "\tInsert Values (%d Z.) Row: %d.:\r\n",z,i-1);
...
#ifdef WITH_BINDCOL
	rc=SQLBindCol(*phstmt,1,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindCol");
	rc=SQLBindCol(*phstmt,2,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindCol");
	rc=SQLBindCol(*phstmt,3,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindCol");
	rc=SQLBindCol(*phstmt,4,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLBindCol");
#endif
	i=1;
	while (1) {
	...
	rc=SQLGetData(*phstmt,1,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	if (rc == SQL_ERROR) ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLGetData");
	rc=SQLGetData(*phstmt,2,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	if (rc == SQL_ERROR) ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLGetData");
	rc=SQLGetData(*phstmt,3,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	if (rc == SQL_ERROR) ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLGetData");
	rc=SQLGetData(*phstmt,4,SQL_C_CHAR,rc_value,(MAX_DATA)+1,&cbvalue);
	if (rc == SQL_ERROR) ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLGetData");
#endif
		i++;
	}
	...
	z = lstrlen(rc_value);
	szLogPrintf(lpSrvr,FALSE,"\tSelect Value (%d Z.) Row: %d.:\r\n",z,i-1);
