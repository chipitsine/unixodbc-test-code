...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von SQLTABLES mit Zeitmessung
**
****************************************************************************
*/
#ifndef WIN32
...
/* ------------------------------------------------------------------------- */
	...
	CheckTime(timebuf1, timebuf2, "SQLTables (list for all qualifier)", lpSrvr, 0);/*Output time*/
...
*/
	...
	CheckTime(timebuf1, timebuf2, "SQLTables (list for all owners)", lpSrvr, 0);/*Output time*/
...
*/
	...
	CheckTime(timebuf1, timebuf2, "SQLTables (list for all types)", lpSrvr, 0);/*Output time*/
...
*/
	...
	CheckTime(timebuf1, timebuf2, "SQLTables (list for search pattern)", lpSrvr, 0);/*Output time*/
