...
/* ------------------------------------------------------------------------- */
	...
	lstrcat(create," (ID INTEGER, NAME CHAR(80), VNAME CHAR(80), STR CHAR(120), ORT CHAR(60), AGE SMALLINT, GEHALT DEC(8,2))");
...
/* ------------------------------------------------------------------------- */
	...
	CheckTime(timebuf1, timebuf2, "SQLStatistics", lpSrvr, 0);/*Output time*/
	...
	CheckTime(timebuf1, timebuf2, "SQLStatistics (fetch information)", lpSrvr, 0);/*Output time*/
	}
