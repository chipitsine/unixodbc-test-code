...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG Datentyp 1MB šbertragung.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "NETLONGTEST"
#define TABLE "TABLONG"
...
/* ---------------------------------------------------------------------har- */
	...
	rc = SQLBindParameter(*phstmt, 1, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_LONGVARCHAR, MAX_VALUE+1, 0, value, 0, &cbvalue);
