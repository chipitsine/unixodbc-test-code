...
SWORD FAR PASCAL DoMFetchTest(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoMFetchObTest(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoMFetchOpTest(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoNetCharTest(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoNetLongTest(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
// -------------------- ----------------------- ------------------------
	idsCharUpdate,	        idsCharUpdateDesc,	        DoCharUpdate,
	idsDTypConvert,	        idsDTypConvertDesc,	        DoDTypConvert,
	idsMFetchTest,	        idsMFetchTestDesc,	        DoMFetchTest,
	idsMFetchObTest,	idsMFetchObTestDesc,	        DoMFetchObTest,
	idsMFetchOpTest,	idsMFetchOpTestDesc,	        DoMFetchOpTest,
	idsNetCharTest,	        idsNetCharTestDesc,	        DoNetCharTest,
	idsNetLongTest,	        idsNetLongTestDesc,	        DoNetLongTest,
	idsNetVarcharTest,      idsNetVarcharTestDesc,	        DoNetVarcharTest,
