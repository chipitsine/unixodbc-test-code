...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von DBS-FLOAT Datentype
**
****************************************************************************
*/
#ifndef WIN32
...
/* ---------------------------------------------------------------------har- */
	...
	rc = SQLBindParameter(*phstmt, 1, SQL_PARAM_INPUT, SQL_C_DOUBLE,
	...
	lstrcpy(select,"SELECT NUMBERS1 FROM ");
	...
	rc = SQLBindCol(*phstmt, 1, SQL_C_DOUBLE, &num, 0, NULL);
