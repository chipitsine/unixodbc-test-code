...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von INTEGER Datentype
**
****************************************************************************
*/
#ifndef WIN32
...
/* ---------------------------------------------------------------------har- */
	...
	lstrcat(create," (NUMBERS1 INTEGER)");
	...
	rc = SQLBindCol(*phstmt, 1, SQL_C_LONG, &num, 0, NULL);
