...
SWORD FAR PASCAL DoSQLAllocEnv(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLAllocStmt(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
SWORD FAR PASCAL DoSQLExecDirect(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLExecute(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLFetch(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLFreeConnect(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLFreeEnv(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLFreeStmt(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLGetCursorName(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
// -------------------- ----------------------- ------------------------
	idsSQLAllocConnect,     idsSQLAllocConnectDesc,         DoSQLAllocConnect,
	idsSQLAllocEnv,         idsSQLAllocEnvDesc,             DoSQLAllocEnv,
	idsSQLAllocStmt,        idsSQLAllocStmtDesc,            DoSQLAllocStmt,
	idsSQLBindCol,          idsSQLBindColDesc,              DoSQLBindCol,
	idsSQLCancel,	        idsSQLCancelDesc,               DoSQLCancel,
	idsSQLColAttributes,    idsSQLColAttributesDesc,        DoSQLColAttributes,
	idsSQLConnect,          idsSQLConnectDesc,              DoSQLConnect,
	idsSQLDescribeCol,      idsSQLDescribeColDesc,          DoSQLDescribeCol,
	idsSQLDisconnect,       idsSQLDisconnectDesc,           DoSQLDisconnect,
	idsSQLError,            idsSQLErrorDesc,                DoSQLError,
	idsSQLExecDirect,       idsSQLExecDirectDesc,           DoSQLExecDirect,
	idsSQLExecute,          idsSQLExecuteDesc,              DoSQLExecute,
	idsSQLFetch,            idsSQLFetchDesc,                DoSQLFetch,
	idsSQLFreeConnect,      idsSQLFreeConnectDesc,          DoSQLFreeConnect,
	idsSQLFreeEnv,          idsSQLFreeEnvDesc,              DoSQLFreeEnv,
	idsSQLFreeStmt,         idsSQLFreeStmtDesc,             DoSQLFreeStmt,
	idsSQLGetCursorName,    idsSQLGetCursorNameDesc,        DoSQLGetCursorName,
	idsSQLNumResultCols,    idsSQLNumResultColsDesc,        DoSQLNumResultCols,
	idsSQLPrepare,          idsSQLPrepareDesc,              DoSQLPrepare,
	idsSQLRowCount,         idsSQLRowCountDesc,             DoSQLRowCount,
	idsSQLSetCursorName,    idsSQLSetCursorNameDesc,        DoSQLSetCursorName,
	idsSQLTransact,         idsSQLTransactDesc,             DoSQLTransact
	};
