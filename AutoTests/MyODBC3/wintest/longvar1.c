...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG-Spalten 1.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "LONGVARS1"
#define TABLE "TABLONG1"
...
/* ---------------------------------------------------------------------har- */
	...
	rc = SQLGetData(*phstmt,1,SQL_C_CHAR,rc_value,MAX_LONG,&cbvalue);
