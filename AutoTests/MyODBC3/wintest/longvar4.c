...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG-Spalten 4.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "LONGVARS4"
#define TABLE "TABLONG4"
...
/* ---------------------------------------------------------------------har- */
	...
	szLogPrintf(lpSrvr,FALSE,"\tSelect Values %d.: ->'%s'\r\n",i,buffer);
	...
	ERRORCHECK(*phenv,*phdbc,*phstmt,lpSrvr,SQL_SUCCESS,rc,"SQLExecFreeStmt");
