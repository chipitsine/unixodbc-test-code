...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG-Spalten 6.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "LONGVARS6"
#define TABLE "TABLONG6"

#define MAX_NAME_LEN 50
#define MAX_LONG     10240
#define MAX_STR      120
//*-------------------------------------------------------------------------
...
/* ---------------------------------------------------------------------har- */
	...
	rc = SQLBindParameter(*phstmt, 1, SQL_PARAM_INPUT, SQL_C_CHAR,
			SQL_LONGVARCHAR, MAX_LONG, 0, value, MAX_LONG, &cbvalue);
	...
	rc=SQLBindCol(*phstmt,1,SQL_C_CHAR,rc_value,MAX_LONG-10,&cbvalue);
