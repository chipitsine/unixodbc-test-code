...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG-Spalten 7.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "LONGVARS7"
#define TABLE "TABLONG7"
...
/* ---------------------------------------------------------------------har- */
	...
	rc=SQLBindCol(*phstmt,1,SQL_C_CHAR, rc_value,(MAX_LONG-10)+1,&cbvalue);
