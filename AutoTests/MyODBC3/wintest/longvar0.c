...
** Option       : --
**
** Purpose      : Auto Test DLL, Test von LONG-Spalten NULL-Value.
**
****************************************************************************
*/
#ifndef WIN32
...
//*-------------------------------------------------------------------------
#define TESTNAME "LONGVARS0"
#define TABLE "TABLONG0"
...
/* ---------------------------------------------------------------------har- */
	...
	rc = SQLGetData(*phstmt,1,SQL_C_CHAR,rc_value,MAX_NAME_LEN,&cbvalue);
	...
	if (cbvalue == SQL_NULL_DATA) lstrcpy(rc_value,VALUE_NULL);
	sprintf(buffer,"%s",rc_value);
