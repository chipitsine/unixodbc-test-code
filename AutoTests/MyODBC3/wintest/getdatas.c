...
//*---------------------------------------------------------------------------------
//| DoGetDataS:
//|     This test case will test the functions SQLGetData write and read from
//|     database.
//|
//|
//| Returns:
				...
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr)
{
	...
	SWORD                   sErr=0;
/* ------------------------------------------------------------------------- */
	UCHAR                   create[MAX_NAME_LEN+MAX_NAME_LEN+MAX_NAME_LEN+1];
...
*/
	...
	if (rc == SQL_SUCCESS) {
		...
		while (1) {
			cbvalue = SQL_NTS;
			rc=SQLGetData(*phstmt,1,SQL_C_CHAR,rc_value, MAX_READ, &cbvalue);
