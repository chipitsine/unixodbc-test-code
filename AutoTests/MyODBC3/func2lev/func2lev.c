...
SWORD FAR PASCAL DoSQLDrivers(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLExtendedFetch(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
// -------------------- ----------------------- ------------------------
	idsSQLBrowseConnect,    idsSQLBrowseConnectDesc,        DoSQLBrowseConnect,
	idsSQLColumnPrivileges, idsSQLColumnPrivilegesDesc,     DoSQLColumnPrivileges,
	idsSQLDataSources,      idsSQLDataSourcesDesc,          DoSQLDataSources,
	idsSQLDescribeParam,    idsSQLDescribeParamDesc,        DoSQLDescribeParam,
	idsSQLDrivers,          idsSQLDriversDesc,              DoSQLDrivers,
	idsSQLExtendedFetch,    idsSQLExtendedFetchDesc,        DoSQLExtendedFetch,
	idsSQLForeignKeys,      idsSQLForeignKeysDesc,          DoSQLForeignKeys,
	idsSQLMoreResults,      idsSQLMoreResultsDesc,          DoSQLMoreResults,
	idsSQLNativeSql,        idsSQLNativeSqlDesc,            DoSQLNativeSql,
	idsSQLNumParams,        idsSQLNumParamsDesc,            DoSQLNumParams,
	idsSQLParamOptions,     idsSQLParamOptionsDesc,         DoSQLParamOptions,
	...
	idsSQLSetPos, 		idsSQLSetPosDesc,		DoSQLSetPos,
	idsSQLSetScrollOptions, idsSQLSetScrollOptionsDesc,     DoSQLSetScrollOptions,
