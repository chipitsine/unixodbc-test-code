...
//|                                     UNIXTEST.C      This shource file with test code
//|                                     UNIXTEST.H      Include files with defines, macros, and prototypes
//|                                     UNIXTEST.RC     Resource file for string tables
...
// -------------------- ----------------------- ------------------------
	idsConnectMix,          idsConnectMixDesc,              DoConnectMix,
	idsDateTime,            idsDateTimeDesc,                DoDateTime,
	idsSQLGetInfo,          idsSQLGetInfoDesc,              DoSQLGetInfo,
	idsSetConnectOption,    idsSetConnectOptionDesc,        DoSetConnectOption,
