...
SWORD FAR PASCAL DoSQLGetInfo(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLGetStmtOption(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
SWORD FAR PASCAL DoSQLPutData(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
SWORD FAR PASCAL DoSQLSetConnectOpt(HENV FAR * phenv, HDBC FAR * phdbc,
				HSTMT FAR * phstmt, lpSERVERINFO lpSrvr);
...
// -------------------- ----------------------- ------------------------
	idsSQLBindParameter,    idsSQLBindParameterDesc,        DoSQLBindParameter,
	idsSQLColumns,          idsSQLColumnsDesc,              DoSQLColumns,
	idsSQLDriverConnect,    idsSQLDriverConnectDesc,        DoSQLDriverConnect,
	idsSQLGetConnectOpt,    idsSQLGetConnectOptDesc,        DoSQLGetConnectOpt,
	idsSQLGetData,          idsSQLGetDataDesc,              DoSQLGetData,
	idsSQLGetFunctions,     idsSQLGetFunctionsDesc,         DoSQLGetFunctions,
	idsSQLGetInfo,          idsSQLGetInfoDesc,              DoSQLGetInfo,
	idsSQLGetStmtOption,    idsSQLGetStmtOptionDesc,        DoSQLGetStmtOption,
	idsSQLGetTypeInfo,      idsSQLGetTypeInfoDesc,          DoSQLGetTypeInfo,
	idsSQLParamData,        idsSQLParamDataDesc,            DoSQLParamData,
	idsSQLPutData,          idsSQLPutDataDesc,              DoSQLPutData,
	idsSQLSetConnectOpt,    idsSQLSetConnectOptDesc,        DoSQLSetConnectOpt,
	idsSQLSetStmtOption,    idsSQLSetStmtOptionDesc,        DoSQLSetStmtOption,
