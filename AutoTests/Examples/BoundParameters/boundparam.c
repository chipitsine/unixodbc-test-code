...
MY_EXPORT BOOL AutoTestName(LPSTR szName, UINT FAR * pcbTestCases)
{
...
MY_EXPORT BOOL AutoTestDesc(UWORD iTest, LPSTR szName, LPSTR szDesc)
{
...
MY_EXPORT void AutoTestFunc(lpSERVERINFO lpSrvr)
{
	int		    iDex;
