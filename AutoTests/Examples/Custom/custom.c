...
//*---------------------------------------------------------------------------------
MY_EXPORT BOOL EXTFUN AutoTestName(LPSTR szName, UINT FAR * pcbTestCases)
{
...
//*---------------------------------------------------------------------------------
MY_EXPORT BOOL EXTFUN AutoTestDesc(UWORD iTest, LPSTR szName, LPSTR szDesc)
{
...
//|	Nothing
//*---------------------------------------------------------------------------------
MY_EXPORT void EXTFUN AutoTestFunc(lpSERVERINFO lpSrvr)
{
	HENV 		henv=NULL;
	HDBC 		hdbc=NULL;
	HSTMT 	hstmt0=NULL;
