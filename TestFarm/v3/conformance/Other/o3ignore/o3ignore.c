/*!**********************************************************************
  ...
  description:  Use SQLSet with option SQL_UPDATE. Set *octetLengthPtr of
...
{
    { SQL_UPDATE, 21, sizeof(UDWORD), "update1", SQL_NTS,    "",        SQL_IGNORE },
    { SQL_UPDATE, 22, sizeof(UDWORD), "",        SQL_IGNORE, "update2", SQL_NTS },
    { SQL_UPDATE, 23, sizeof(UDWORD), "",        SQL_IGNORE, "update3", SQL_NTS },
    { SQL_UPDATE, 24, sizeof(UDWORD), "update4", SQL_NTS,    "update5", SQL_NTS },
    { SQL_UPDATE, 25, SQL_IGNORE,     "",        SQL_IGNORE, "",        SQL_IGNORE },
    { SQL_UPDATE, 26, sizeof(UDWORD), "update6", SQL_NTS,    "update7", SQL_NTS },
    { SQL_UPDATE, 24, SQL_IGNORE,     "update8", SQL_NTS,    "update9", SQL_NTS },
    { 0, 0, 0, NULL, 0, NULL, 0 }
}; /* setPosTests */
...
SQLRETURN RunTest( TestCase *tests )
{
    ...
    for (actTest = tests; actTest->charValue1 != NULL; actTest++) {
        ...
        SPRINTF( textBuffer,
                 "UpdateValues\t -- SetPos(SQL_UPDATE) \t\t retcode: %s"CRLF,
                 cnvret( retcode ));
        PRINTF( textBuffer );
        ErrorCheck( SQL_HANDLE_STMT, hstmt );
    }; /* for */
