...
TestValues TestCase[] = {
{SQL_API_SQLEXECDIRECT, "", "", "", "DROP TABLE "TABLE, 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "DROP TABLE "TABLE"X", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "create table "TABLE"X (i int, c char(10), primary key (i))", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "create table "TABLE" (i int, c char(10), foreign key (i) references "TABLE"X (i))", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "grant select (i) on "TABLE" TO public", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "create unique index ind"TABLE" on "TABLE" (c)", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "insert into "TABLE"X values (1, 'abc')", 0, "", 0},
{SQL_API_SQLEXECDIRECT, "", "", "", "insert into "TABLE" values (1, 'abc')", 0, "", 0},
{SQL_API_SQLPREPARE, "", "", "", "select * from "TABLE, 0, "", 0},
{SQL_API_SQLEXECUTE, "", "", "", "", 0, "", 0},
{SQL_API_SQLTABLES, "", TABLE, "", "TABLE", 0, "", 0},
{SQL_API_SQLCOLUMNS, "", TABLE, "%", "", 0, "", 0},
{SQL_API_SQLSTATISTICS, "", TABLE, "", "", SQL_INDEX_ALL, "", SQL_ENSURE},
{SQL_API_SQLTABLEPRIVILEGES, "", TABLE, "", "", 0, "", 0},
{SQL_API_SQLCOLUMNPRIVILEGES, "", TABLE, "I", "", 0, "", 0},
{SQL_API_SQLPRIMARYKEYS, "", TABLE"X", "", "", 0, "", 0},
{SQL_API_SQLFOREIGNKEYS, "", TABLE"X", "", "", 0, TABLE, 0},
{SQL_API_SQLPROCEDURES, "", "PROC1", "", "", 0, "", 0},
{SQL_API_SQLPROCEDURECOLUMNS, "", "PROC1", "P1", "", 0, "", 0},
{0, "", "", "", "", 0, "", 0},
};

TestValues *AllTest[] = {TestCase, NULL};
...
int AsyncThreadProc(TestValues *TestCase)
{
  ...
  SPRINTF(buffer, " AsyncThreadProc running GREPWEG(%x)"CRLF, TestCase);
  PRINTF(buffer);
  ...
  SQLExecDirect (hstmt, "DROP TABLE "TABLE"", SQL_NTS);
  SQLExecDirect (hstmt, "DROP TABLE "TABLE"X", SQL_NTS);
     ...
     while (retcode == SQL_STILL_EXECUTING) {
        switch(p->cbFunction) {
           case (SQL_API_SQLEXECDIRECT): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLExecDirect (%s)", SQLGETTHREADID(), cnvret(retcode));
		/* PRINTF(buffer); */
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLPREPARE): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLPrepare (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLEXECUTE): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLExecute (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLTABLES): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLTables (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLCOLUMNS): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLColumns (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLSTATISTICS): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLStatistics (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLTABLEPRIVILEGES): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLTablePrivileges (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLCOLUMNPRIVILEGES): {
              ...
              p->szTableName, SQL_NTS, p->szColumnName, SQL_NTS);
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLColumnPrivileges (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLPRIMARYKEYS): {
              ...
              p->szTableName, SQL_NTS);
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLPrimaryKeys (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLFOREIGNKEYS): {
              ...
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLForeignKeys (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLPROCEDURES): {
              ...
              p->szTableName, SQL_NTS);
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLProcedures (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
           ...
           case (SQL_API_SQLPROCEDURECOLUMNS): {
              ...
              p->szTableName, SQL_NTS, p->szColumnName, SQL_NTS);
              if (first || retcode != SQL_STILL_EXECUTING) {
                SPRINTF(buffer," %ld SQLProcedureColumns (%s)", SQLGETTHREADID(), cnvret(retcode));
		PRINTF(buffer);
	      }
              ERROR_CHECK(hstmt);
              break;
