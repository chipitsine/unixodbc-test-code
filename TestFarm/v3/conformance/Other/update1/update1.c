...
int main(int argc, argv_t argv)
{
  ...
  retcode = SQLExecDirect (hstmt, "insert \""TABLE"\" values ('row2')", SQL_NTS);
  SPRINTF(buffer, " SQLExecDirect retcode: %s"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt);

  retcode = SQLExecDirect (hstmt, "insert \""TABLE"\" values ('last row')", SQL_NTS);
  SPRINTF(buffer, " SQLExecDirect retcode: %s"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt);
  ...
  retcode = SQLSetCursorName (hstmt, "C"TABLE, SQL_NTS);
  SPRINTF(buffer," SQLSetCursorName retcode: %d"CRLF, retcode);
  PRINTF(buffer);
  ERROR_CHECK(hstmt);

  retcode = SQLExecDirect (hstmt, "select * from \""TABLE"\" for update of col1", SQL_NTS);
  SPRINTF(buffer, " SQLExecDirect retcode: %s"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt);
  ...
  retcode = SQLExecDirect (hstmt1, "update \""TABLE"\" set col1 = '"TABLE"' where current of \"C"TABLE"\"", SQL_NTS);
  SPRINTF(buffer, " SQLExecDirect retcode: %s"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt1);
  ...
  retcode = SQLExecDirect (hstmt, "select * from \""TABLE"\" for update of", SQL_NTS);
  SPRINTF(buffer, " SQLExecDirect retcode: %s"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt);
