 ...
 * wird.
 * Hier wird Massenfetch mit Tabellen > 250 Zeilen getestet, wobei über
 * die buffergrenze hinaus mit fetch relative gefetched wird.
 *
 * Dieses Programm unterscheidet sich von optcur6 nur darin, daß statt
 * einer char spalte eine long spalte vorkommt.
...
{ SQL_FETCH_ABSOLUTE, 255, "", 0, 0 },
{ SQL_FETCH_RELATIVE, +100, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -300, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_FIRST, 0, "", 0, 0 },
{ SQL_FETCH_ABSOLUTE, 249, "", 0, 0 },
{ SQL_FETCH_NEXT, 0, "", 0, 0 },
{ SQL_FETCH_NEXT, 0, "", 0, 0 },
{ SQL_FETCH_NEXT, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -100, "", 0, 0 },
{ SQL_FETCH_RELATIVE, +200, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_FIRST, 0, "", 0, 0 },
{ SQL_FETCH_ABSOLUTE, 251, "", 0, 0 },
{ SQL_FETCH_PRIOR, 0, "", 0, 0 },
{ SQL_FETCH_PRIOR, 0, "", 0, 0 },
{ SQL_FETCH_PRIOR, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 100, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -200, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_FIRST, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 251, "", 0, 0 },
{ SQL_FETCH_ABSOLUTE, 55, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 148, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -300, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_FIRST, 0, "", 0, 0 },
{ SQL_FETCH_LAST, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -251, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 155, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -300, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_LAST, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 0, "", 0, 0 },
{ SQL_FETCH_RELATIVE, 155, "", 0, 0 },
{ SQL_FETCH_RELATIVE, -300, "", 0, 0 },
{ SQL_SELECT_NEW, 1, "", SQL_CURSOR_KEYSET_DRIVEN, SQL_CONCUR_READ_ONLY },
{ SQL_FETCH_FIRST, 0, "", 0, 0 },
...
UCHAR szCHAR[MAXROWS][LONG_SIZE];
...
int main(int argc, argv_t argv)
{
  ...
  STRCPY(stmt, "create table "TABLE"(i integer, c long)");
  SPRINTF(buffer, "%s"CRLF, stmt);
  PRINTF(buffer);
  retcode = SQLExecDirect (hstmt, stmt, STRLEN(stmt));
  ...
  retcode = SQLBindParameter(hstmt, 2, SQL_PARAM_INPUT, SQL_C_DEFAULT,
     fSqlType, cbColDef, ibScale, &szCHAR[0], 0, &pcblong );
  SPRINTF(buffer, " SQLBindParameter retcode '%s'"CRLF, cnvret(retcode));
  PRINTF(buffer);
  ERROR_CHECK(hstmt);
  ...
  for (row = 0; row < NUM_ROWS; row++) {
     ...
     MEMSET( &szCHAR[0][11], 'x', LONG_SIZE-14 );
...
int DoSelect(int rowset, DWORD fSqlCursorType, DWORD fSqlConcur)
{
  ...
  STRCPY(stmt, "select * from optcur7");
  SPRINTF(buffer, "%s"CRLF, stmt);
  PRINTF(buffer);
  retcode = SQLExecDirect (hstmt, stmt, STRLEN(stmt));
