...
SFLOAT sFLOAT1=0, sFLOAT2=1.23456F, sFLOAT3=3.4e38F;
SDOUBLE sDOUBLE;
...
{SQL_C_CHAR,       "-0.0",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.1e+1",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.1e-1",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_FLOAT,      &sFLOAT1,     NULL, SQL_C_FLOAT,     &sFLOAT,     sizeof(sFLOAT),     sizeof(szCHAR), &cbFLOAT},
{SQL_C_FLOAT,      &sFLOAT2,     NULL, SQL_C_FLOAT,     &sFLOAT,     sizeof(sFLOAT),     sizeof(szCHAR), &cbFLOAT},
{SQL_C_FLOAT,      &sFLOAT3,     NULL, SQL_C_FLOAT,     &sFLOAT,     sizeof(sFLOAT),     sizeof(szCHAR), &cbFLOAT},
{0, 0, 0, 0, 0, 0, 0}
};

static TestTypesStruct TestTypeMaxReal[] = {
{SQL_C_CHAR,       "3.3e38",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "3.4e38",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "3.5e38",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "3.3e-38",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "3.4e-38",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "3.5e-38",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-3.3e38",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-3.4e38",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-3.5e38",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-3.3e-38",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
{SQL_C_CHAR,       ".33e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".34e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".35e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "33e-39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "34e-39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "35e-39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.33e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.34e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.35e39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-33e-39",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
{SQL_C_CHAR,       "33e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "34e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "35e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".33e-37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".34e-37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".35e-37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-33e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-34e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-35e37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.33e-37",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
static TestTypesStruct TestTypeFloat[] = {
{SQL_C_CHAR,       "+0.0",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-0.0",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.1e+1",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.1e-1",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_DOUBLE,     &sDOUBLE1,     NULL, SQL_C_DOUBLE,     &sDOUBLE,     sizeof(sDOUBLE),     sizeof(szCHAR), &cbDOUBLE},
{SQL_C_DOUBLE,     &sDOUBLE2,     NULL, SQL_C_DOUBLE,     &sDOUBLE,     sizeof(sDOUBLE),     sizeof(szCHAR), &cbDOUBLE},
{SQL_C_DOUBLE,     &sDOUBLE3,     NULL, SQL_C_DOUBLE,     &sDOUBLE,     sizeof(sDOUBLE),     sizeof(szCHAR), &cbDOUBLE},
{0, 0, 0, 0, 0, 0, 0, 0}
};

static TestTypesStruct TestTypeMaxFloat[] = {
{SQL_C_CHAR,       "9.8e62",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "9.99999999999999e62",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "10e62",      NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "9.8e-62",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "9.99999999999999e-62",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "10e-62",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-9.8e62",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-9.99999999999999e62",    NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-10e62",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-9.8e-62",   NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
{SQL_C_CHAR,       ".98e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".999999999999999e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.0e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "98e-63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "99.9999999999999e-63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "100e-63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.98e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,      "-.999999999999999e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-1.0e63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-98e-63",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
{SQL_C_CHAR,       "98e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "99.9999999999999e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "100e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".98e-61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       ".999999999999999e-61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "1.0e-61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-98e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-99.9999999999999e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-100e61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
{SQL_C_CHAR,       "-.98e-61",     NULL, SQL_C_CHAR,      szCHAR,     sizeof(szCHAR),     sizeof(szCHAR), &cbCHAR},
...
{SQL_REAL, "REAL", "create table "TABLE" (n integer, col float(7))", 100, 0, TestTypeReal },
{SQL_REAL,  "MAXREAL",  "create table "TABLE" (n integer, col real(7))", 100, 0, TestTypeMaxReal },
{SQL_FLOAT, "FLOAT", "create table "TABLE" (n integer, col float(15))", 100, 0, TestTypeFloat },
{SQL_FLOAT, "MAXFLOAT", "create table "TABLE" (n integer, col float(15))", 100, 0, TestTypeMaxFloat },
  {0, NULL, NULL, 0, 0, TestTypeMaxFloat}
};
...
SQLLEN *pcbValueOut)
{
   ...
   if (retcode == SQL_SUCCESS) {
      ...
      MEMSET(rgbValueOut, INIT_CHAR, (size_t)cbSizeofValueOut);
...
VOID rgbValueShow(SWORD fCType, PTR rgbValue, SQLLEN *pcbValue)
{
#define LOCALBUFSIZE BUFSIZE-100
   UCHAR localbuf[LOCALBUFSIZE];
   SDWORD len;
   switch (fCType) {
      case (SQL_C_CHAR): {
	 ...
	 if (len < LOCALBUFSIZE) {
	    MEMCPY(localbuf, rgbValue, (size_t)len);
	    localbuf[len] = '\0';
	    SPRINTF(buffer, "SQL_C_CHAR = '%s'", localbuf);
	    PRINTF(buffer);
	    localbuf[0] ='\0';
	 }
	 else {
	    MEMCPY(localbuf, rgbValue, LOCALBUFSIZE/3);
	    localbuf[LOCALBUFSIZE/3] = '\0';
	    SPRINTF(buffer, "SQL_C_CHAR = '%s"CRLF, localbuf);
	    PRINTF(buffer);
	    MEMCPY(localbuf, (char *)rgbValue+len-BUFSIZE/3, LOCALBUFSIZE/3);
	    localbuf[LOCALBUFSIZE/3] = '\0';
	    SPRINTF(buffer, "........"CRLF"%s'", localbuf);
	    PRINTF(buffer);
	    localbuf[0] ='\0';
	 }
	 break;
	 ...
	 break;
      ...
      case (SQL_C_DOUBLE): {
        int len;
	 SPRINTF(localbuf, "SQL_C_DOUBLE = %g", * (SDOUBLE FAR *)rgbValue);

         len = strlen (localbuf);         /* some machine print exponent with 3 */
         if (localbuf[len-3] == '0') {    /* digits, other with 2               */
           localbuf[len-3] = localbuf[len-2];
           localbuf[len-2] = localbuf[len-1];
           localbuf[len-1] = localbuf[len];
         }
	 break;
      }
      case (SQL_C_FLOAT): {
        int len;
	 SPRINTF(localbuf, "SQL_C_FLOAT = %g", * (SFLOAT FAR *)rgbValue);
         len = strlen (localbuf);         /* some machine print exponent with 3 */
         if (localbuf[len-3] == '0') {    /* digits, other with 2               */
           localbuf[len-3] = localbuf[len-2];
           localbuf[len-2] = localbuf[len-1];
